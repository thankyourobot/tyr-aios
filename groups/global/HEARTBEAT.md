...
```
<internal>Checked recent activity, open assignments, and workpapers. Nothing actionable for a lightweight heartbeat.</internal>
```
...
None defined. Add agent-specific sources here when customizing.
