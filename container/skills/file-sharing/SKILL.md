...
```
https://files.thankyourobot.ai/files/agent-workspaces/{group-name}/{path-relative-to-workspace}
```

**Examples:**
- A file at `/workspace/group/projects/report.md` for group `museminded`:
  `https://files.thankyourobot.ai/files/agent-workspaces/museminded/projects/report.md`
- A file at `/workspace/group/projects/deliverable.pdf` for group `growth`:
  `https://files.thankyourobot.ai/files/agent-workspaces/growth/projects/deliverable.pdf`
...
- Spaces in file/folder names must be URL-encoded (e.g., `my%20file.md`)
